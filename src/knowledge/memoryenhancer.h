...
public:
    explicit MemoryEnhancer(Embedder* embedder, VectorDB* vectorDB, QObject* parent = nullptr);
    ...
    QVector<MemoryEntry> parseFromResponse(const QString& response, const QString& conversationId);
